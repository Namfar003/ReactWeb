  ...
  return (
    <>
      <Form onSubmit={handleSubmit}>
        ...
        />
        {error?.firstname && (
          <p className="text-danger mt-1 font">firstname is required</p>
        )}
        ...
        />
        {error?.lastname && (
          <p className="text-danger mt-1 font">lastname is required</p>
        )}
        ...
        <div className="mb-5 mt-3 d-flex justify-content-between align-items-center mt-2">
          ...
          <div>
            <h6>
              ລົງທະບຽນເເລ້ວ <Link to="/login">ເຂົ້າສູ່ລະບົບ</Link>{" "}
            </h6>
          </div>
        </div>
      </Form>
